...
logger = util.set_logger(os.path.join(log_path, city_name, 'log', "factsheet.log"))

taz_boundry_file = config["etl"]["taz_boundary_path"]
regioncities_boundary_path = config["etl"]["cities_boundary_path"]
...
relinkspath = config['etl']['bayareareclassify']
rawregulatorpath = config['etl']["rawregulator_path"]
regulator_path = config['etl']["regulator_path"]
...
# coc
bayarea_coc_links = config["etl"]["coc_links"]
bayarea_coc_shapefile = config["etl"]["coc_shapefile"]
