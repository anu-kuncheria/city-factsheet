...
def vhd(flow, speed, delaydf = False):
    ...
    d_delay[d_delay<0] = 0 #convert negative delays to 0 . Negative delays occur because sometimes speeds are higher in 4th digit in the simulation due to rounding off numeric error in simulator
