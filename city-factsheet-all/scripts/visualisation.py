...
def visuals():
    ...
    if 'vmt' in system_metric.columns:
        ...
        city_boundry.boundary.plot(ax=ax, color='grey', linewidth=1.5)
        ...
        logger.info("vmt column not found in the dataset")
    ...
    if 'adt' in system_metric.columns:
        ...
        logger.info("adt column not found in the dataset")
    ...
    if 'vhd_sec' in system_metric.columns:
        ...
        logger.info("vhd column not found in the dataset")
    ...
    if 'fuel_lit' in system_metric.columns:
        ...
        logger.info("fuel column not found in the dataset")
